...
exports.run = (client, message, args) => {
  ...
  if (reason.length < 1) return message.reply('Kimi ne sebeple sürgün edeyim onu yaz :P');
  if (message.mentions.users.size < 1) return message.reply('Kimi sürgün edeyim ?').catch(console.error);
